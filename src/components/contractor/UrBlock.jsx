        ...
        <View>
            ...
            <View style={styles.usersBlock}>
                <View style={styles.usersBlockText}>
                    <Text style={styles.usersBlockTitle}>ООО "ДЖЕТПАРТС"</Text>
                    ...
                    <View style={styles.usersBlockGroups}>
                        ...
                        <View style={styles.usersBlockGroupsContainer}>
                            <Text style={styles.usersBlockGroupsText}>Моя компания</Text>
                        </View>
                        <View style={styles.usersBlockGroupsContainer}>
                            <Text style={styles.usersBlockGroupsText}>Юр. лицо</Text>
                        </View>
                        <View style={styles.usersBlockGroupsContainer}>
                            <Text style={styles.usersBlockGroupsText}>parts24.su</Text>
                        </View>
                        <View style={styles.usersBlockGroupsContainer}>
                            <Text style={styles.usersBlockGroupsText}>parts24.su</Text>
                        </View>
                        <View style={styles.usersBlockGroupsContainer}>
                            <Text style={styles.usersBlockGroupsText}>parts66.ru</Text>
                        </View>
                    </View>
                </View>
